    ...
    <nav class="navbar navbar-static-top" role="navigation">
      ...
      <div class="navbar-custom-menu">
        ...
        @if(config('app.env') != 'demo')
          <a title="@lang('lang_v1.calendar')" href="{{route('calendar')}}" data-toggle="tooltip" class="btn btn-success btn-flat pull-left m-8 btn-sm mt-10" data-placement="bottom">
        ...
        <div class="m-8 pull-left mt-15 hidden-xs navbar-text-color"><strong>{{ @format_date('now') }}</strong></div>
